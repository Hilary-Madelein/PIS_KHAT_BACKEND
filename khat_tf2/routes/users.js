...
router.post('/practicas/modificar', practicaController.modificar);
router.get('/practica/listar', practicaController.listar);
router.get('/practicas/obtener/:external', practicaController.obtener);
router.post('/practicas/cambiarEstado', practicaController.cambiarEstado);
